...
def get_args():
    ...
    parser.add_argument("--proto_lr", type=float, default=0.001)
    parser.add_argument("--proto_lr_multi", type=float, default=1)

    parser.add_argument("--s_lambda", type=float, default=0.0001)
    parser.add_argument("--sigma", type=float, default=0.3)
    parser.add_argument("--sim_alpha", type=float, default=1)
    ...
    parser.add_argument("--project_name", type=str, default='ProtoSim', help="Main project name")
...
def setup_cfg(args):
    ...
    cfg.PROTOTYPES_LR = args.proto_lr
    cfg.PROTO_LR_MULTI = args.proto_lr_multi
